...
for vacation_destination in data_manager_obj.sheet_data:
    ...
    if flight_data is not None:
        ...
        if flight_data.price < vacation_destination["lowestPrice"]:
            notification_manager.send_message(price=flight_data.price,
            ...
            print(f"SMS with info for cheap flight to {flight_data.arrival_airport_code} sent!")
        else:
            print(f"Flight to {flight_data.arrival_airport_code} is too expensive. No message sent.")
